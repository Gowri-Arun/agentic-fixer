  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        ...
        instructions=[
            ("Open the HTML file containing your FAQ content."),
            (
                "Paste the script tag inside the <head> section "
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    "availability": "https://schema.org/InStock"
        ...
        instructions=[
            "Open the HTML file for the product or service page.",
            (
                "Paste the script tag inside the <head> section "
                "or just before the closing </body> tag."
            ),
  ...
  <ul>
    ...
    <li><a href="/refunds">Refund and Cancellation Policy</a></li>
        ...
        instructions=[
            ...
            (
                "Paste the section near pricing, checkout, "
                "footer, or plan comparison content."
            ),
    ...
    "missing_h1": Fix(
        ...
        instructions=[
            "Open the relevant HTML file.",
            ("Add an H1 heading as the first visible heading in the page body."),
...
<script type="application/ld+json">
{
  ...
  "description": "Page description"
        ...
        instructions=[
            ("Locate the invalid JSON-LD script block in your HTML file."),
            "Remove the broken script tag entirely.",
            ("Replace it with the valid JSON-LD block above."),
            (
                "Validate the JSON syntax: avoid trailing commas, "
                "comments, or unquoted keys."
            ),
            ("Load the page and check the browser console for any JSON parse errors."),
        ],
    ),
}


def generate_plain_html_fix(issue_id: str) -> Fix | None:
