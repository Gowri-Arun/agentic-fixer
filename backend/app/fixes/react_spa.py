  ...
  return (
    <>
      ...
      {/* Existing page content */}
        ...
        instructions=[
            ("Create a JsonLd helper component or add it to your shared components."),
            "Add the faqSchema object near the top of your page file.",
            ("Place the JsonLd component inside the returned JSX."),
            (
  ...
  return (
    <>
      ...
      {/* Existing page content */}
        ...
        instructions=[
            ("Create a JsonLd helper component or add it to your shared components."),
            ("Add the serviceSchema object near the top of your page file."),
            "Place the JsonLd component inside the returned JSX.",
            (
  ...
  return (
    <>
      ...
      {/* Existing page content */}
        ...
        instructions=[
            ("Locate the invalid JSON-LD script block in your component."),
            "Remove the broken script tag entirely.",
            (
                "Replace it with a valid JSON-LD block "
                "using the JsonLd helper component."
            ),
            (
...
def generate_react_spa_fix(issue_id: str) -> Fix | None:
